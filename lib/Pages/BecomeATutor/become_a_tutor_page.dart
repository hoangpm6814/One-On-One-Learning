...
import 'package:lettutor/Pages/BecomeATutor/Input/BasicInfo/country_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/BasicInfo/date_of_birth_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/BasicInfo/name_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/CV/education_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/CV/experience_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/CV/interest_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/CV/job_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/Language/language_input.dart';
import 'package:lettutor/Pages/BecomeATutor/Input/Teaching/teaching_input.dart';
import 'package:lettutor/Pages/BecomeATutor/custom_border_noti.dart';
...
class BecomeATutorPage extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return BecomeATutorPageState();
  }
}

class BecomeATutorPageState extends State<BecomeATutorPage> {
  // String _name;
  // String _country;
  // String _dateOfBirth;
  // String _interest;
